...
function stampaUser() {
  ...
  if ( $res = mysqli_query($connection_mysqli, $select_query) ) {
    ...
    $table="<table>";  
      ...
      if($row['permesso'] == 1) $tipologia_utente = 'cliente';
      else if($row['permesso'] == 10) $tipologia_utente = 'bite courier';
      else if($row['permesso'] == 100) $tipologia_utente = 'gestore';
      else if($row['permesso'] == 1000) $tipologia_utente = 'amministratore';
